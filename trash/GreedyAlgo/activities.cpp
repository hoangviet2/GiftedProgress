// Question link: https://www.techiedelight.com/activity-selection-problem/
#include <iostream>
#include <vector>
#include <algorithm>
...
void selectActivity(vector<Pair> activities)        // no-ref, no-const
{
    ...
    //sort(activities.begin(), activities.end(),[](auto const &lhs, auto const &rhs) return lhs.finish < rhs.finish;});
